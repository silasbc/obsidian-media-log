  ...
  "src/sifi.js"(exports2, module2) {
    ...
    function build({ LibraryView: LibraryView2, MediaLogSettingTab: MediaLogSettingTab2, DEFAULT_SETTINGS: DEFAULT_SETTINGS2, hasTextSelectionWithin: hasTextSelectionWithin2 }) {
      ...
      async function afterCapture(plugin, file) {
        ...
        try {
          const indexed = await waitForCache(plugin.app, file, 3e3);
          let items = [];
          let item = null;
          if (indexed) {
          ...
          if (!item) {
            new Notice2("Media Log: saved, but the tag sheet couldn't find the new note");
            return;
          }
          ...
          const open = () => setTimeout(() => {
            try {
              ...
              new Notice2(`Media Log: saved; tag sheet failed \u2014 ${e && e.message || e}`);
            }
          }, 350);
          ...
          new Notice2(`Media Log: saved; couldn't open the tag sheet \u2014 ${e && e.message || e}`);
        }
      }
      class TvPlayer {
